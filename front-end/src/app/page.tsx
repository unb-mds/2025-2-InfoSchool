            ...
            <ScrollAnimation direction="up" duration={500} delay={200}>
              <div className="text-center p-6 rounded-2xl bg-card border border-theme transition-all duration-500 hover:scale-105 flex flex-col">
                ...
                <div className="bg-background rounded-lg p-4 transition-all duration-500 flex-1 min-h-0">
                  ...
                  >
                    <source src={`${getBasePath()}/gifs/home.webm`} type="video/webm" />
                  </video>
                </div>
              </div>
            </ScrollAnimation>
              ...
              <div className="text-center p-6 rounded-2xl bg-card border border-theme transition-all duration-500 hover:scale-105 flex flex-col">
                ...
                <div className="bg-background rounded-lg p-4 transition-all duration-500 flex-1 min-h-0">
                  <video
                    ...
                    className="w-full h-full rounded-lg object-cover"
                  >
                    <source src={`${getBasePath()}/gifs/explorarescolas.webm`} type="video/webm" />
                  </video>
                </div>
              </div>
            </ScrollAnimation>
              ...
              <div className="text-center p-6 rounded-2xl bg-card border border-theme transition-all duration-500 hover:scale-105 flex flex-col">
                ...
                <div className="bg-background rounded-lg p-4 transition-all duration-500 flex-1 min-h-0">
                  <video
                    ...
                    className="w-full h-full rounded-lg object-cover"
                  >
                    <source src={`${getBasePath()}/gifs/dashboard.webm`} type="video/webm" />
                  </video>
                </div>
              </div>
            </ScrollAnimation>
              ...
              <div className="text-center p-6 rounded-2xl bg-card border border-theme transition-all duration-500 hover:scale-105 flex flex-col">
                ...
                <div className="bg-background rounded-lg p-4 transition-all duration-500 flex-1 min-h-0">
                  <video
                    ...
                    className="w-full h-full rounded-lg object-cover"
                  >
                    <source src={`${getBasePath()}/gifs/rag.webm`} type="video/webm" />
                  </video>
                </div>
              </div>
            </ScrollAnimation>
