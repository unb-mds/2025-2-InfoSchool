    ...
    <div className="min-h-screen bg-background text-text transition-colors duration-300">
      ...
      <section className="max-w-[95%] sm:max-w-[90%] md:max-w-[80%] mx-auto px-3 sm:px-4 py-6 md:py-16"> 
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
          ...
          <div className="flex-1 lg:flex-[0.6] pt-8">
            ...
            <button className="bg-primary text-white rounded-[25px] hover:bg-[#1a6fd8] transition-all duration-200 px-6 sm:px-8 md:px-10 py-3 md:py-4 text-lg sm:text-xl font-semibold hover:scale-105 active:scale-100 sm:min-w-[200px] cursor-pointer text-center"
              style={{ fontFamily: "'Rammetto One', cursive"}}>
              Explorar escolas
            </button>
          </div>
      ...
      <section className="max-w-[95%] sm:max-w-[90%] md:max-w-[80%] mx-auto px-3 sm:px-4 py-6 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-6 justify-items-center">
          ...
          <div className="bg-card-alt rounded-2xl p-4 sm:p-5 md:p-6 text-center transition-all duration-300 w-full max-w-[280px] sm:max-w-[300px] md:max-w-[330px] min-h-[260px] sm:min-h-[280px] md:min-h-[300px] flex flex-col justify-start items-center cursor-pointer transform sm:hover:scale-105 shadow-theme border border-theme">
            <span className="mt-3 sm:mt-4 mb-3 sm:mb-4">
              <FontAwesomeIcon icon={faLocationDot} style={{ color: "#2C80FF", width: "32px", height: "32px" }} />
            </span>
            <h3 className="mb-4 sm:mb-5 text-2xl sm:text-[26px] md:text-[28px] text-text"
                style={{ fontFamily: "'Rammetto One', cursive" }}>
              Caminho normal
            </h3>
            <p className="text-text text-base sm:text-[17px] md:text-[18px]"
               style={{ fontFamily: "'Sansita', sans-serif" }}>
      ...
      <section className="max-w-[95%] sm:max-w-[90%] md:max-w-[85%] mx-auto px-3 sm:px-4 py-8 md:py-12 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-start mb-12 md:mb-16">
          <div className="lg:flex-1">
            <div className="bg-card rounded-2xl p-6 md:p-8 shadow-theme-large border border-theme">
              <p className="text-base md:text-lg lg:text-xl leading-relaxed text-justify text-text"
                 style={{ fontFamily: "'Sansita', sans-serif" }}>
        ...
        {/* LINHA DIVISÓRIA */}
        <div className="border-t border-theme my-12 md:my-16"></div>
...
function DeveloperCard({ photo, name, role, borderColor }: DeveloperCardProps) {
  return (
    <div className="text-center w-full px-1 sm:px-0">
      <div className="bg-card rounded-2xl p-4 sm:p-5 w-full max-w-[280px] sm:max-w-full h-56 sm:h-64 flex flex-col items-center justify-center transform sm:hover:scale-105 transition-all duration-300 shadow-theme-large border border-theme">
        ...
        <div className="space-y-2">
          <span className="text-lg sm:text-xl font-bold text-text block"
                style={{ fontFamily: "'Rammetto One', cursive" }}>
            {name}
          </span>
          <span className="text-text text-sm sm:text-base">{role}</span>
        </div>
      </div>
    </div>
  );
